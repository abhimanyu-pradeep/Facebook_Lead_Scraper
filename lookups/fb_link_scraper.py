...
# === Configuration ===
COUNTRY_CODE = "IN"
SCRAPED_PAGES_CSV = "new_links_test_20250721_151339.csv"
...
# === Wrapper Function ===
def run_scrape_page_links(search_keyword, start_date_min=None, start_date_max=None):
    ...
    if links_data:
        ...
        # Save new links to timestamped file
        timestamp = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
        new_links_file = f"new_links_test_2_{timestamp}.csv"
        new_df.to_csv(new_links_file, index=False)
...
if __name__ == "__main__":
    ...
    run_scrape_page_links(search_keyword, start_date_min, start_date_max)
